...
### Analista de Sistemas | Dados | Business Intelligence

Profissional de Tecnologia da Informação com experiência em sistemas corporativos, bancos de dados, SQL, suporte técnico e desenvolvimento de soluções automatizadas.

Atualmente direcionando minha carreira para a área de **Dados e Business Intelligence**, com foco em transformar dados em informações úteis para análise e tomada de decisão.
...
[Ver projeto →](<./Projetos/Dashboad Trello>)
